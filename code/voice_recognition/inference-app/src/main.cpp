...
int main( void )
{
    ...
    while (1) {
        ...
        //  We are predicting 5 classes:
        // left, right, stop, and up. Left corresponds to 0, noise to 1, right to 2, stop to 3 and up to 4.
        // the variable prediction is checked to see if it is 0,1,2,3 or 4 and the corresponding action is taken.

		printf("%f \n",prediction);

		if (prediction <0.50) {
           printf("noise!\n", prediction);
		  currentp = prediction1; 
        } 
		else
		{
			printf("stop!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! \n");
    ...
    // blink the LED 5 times to indicate the prediction < 0.55
